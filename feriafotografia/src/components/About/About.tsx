      ...
      <div className="container-width">
        ...
        >
          ...
          <div className="body-text space-y-6">
            ...
            <p className="font-bevietnam font-normal">
              Se hizo en los barrios porteños de <span className="font-bevietnam font-thin italic">Villa Crespo, Palermo, San Telmo y 
              Núñez</span>, y también fuera de la capital, en <span className="font-bevietnam font-thin italic">Vicente López y La Plata</span>. 
